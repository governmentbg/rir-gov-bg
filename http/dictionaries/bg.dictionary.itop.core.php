...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Core:/Error/FieldMustBeUnique' => 'Полето трябва да е уникално - %1s е вече използвано.',
...
Операторы:<br/>
	...
	'Core:AttributeFriendlyName' => 'Пълно название',
	'Core:AttributeFriendlyName+' => 'Атрибут создается автоматически; Пълно название вычисляется из нескольких атрибутов',

	'Core:FriendlyName-Label' => 'Пълно название',
	'Core:FriendlyName-Description' => 'Пълно название',
		'Core:AttributePassword' => 'Парола',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Change:ObjectCreated' => 'Записа е създаден.',
	'Change:ObjectDeleted' => 'Записа е изтрит.',
	'Change:ObjectModified' => 'Записа е променен.',
	'Change:AttName_SetTo_NewValue_PreviousValue_OldValue' => 'Атрибут "%1$s" с нова стойност "%2$s" (предишна стойност: "%3$s").',
	'Change:AttName_SetTo' => 'Атрибут "%1$s" въведен "%2$s".',
	'Change:Text_AppendedTo_AttName' => 'Добавени данни  "%1$s" в атрибут "%2$s".',
	'Change:AttName_Changed_PreviousValue_OldValue' => 'Атрибут "%1$s" променен  (предишна стойност "%2$s").',
	'Change:AttName_Changed' => 'Атрибут "%1$s" променен.',
	'Change:AttName_EntryAdded' => 'В атрибут "%1$s" са добваени нови данни.',
	'Change:LinkSet:Added' => 'Добавена връзка %1$s.',
	'Change:LinkSet:Removed' => 'Премахната връзка %1$s.',
	'Change:LinkSet:Modified' => 'Променена връзка %1$s.',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	...
	'Class:EventLoginUsage/Attribute:user_id' => 'Потребителско име~~',
	'Class:EventLoginUsage/Attribute:user_id+' => 'Потребителско име',
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	...
	'Class:Action/Attribute:trigger_list+' => 'Тригеры, которые запускают данное действие',
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnObject' => 'Тригер (на класс объекта)',
	'Class:TriggerOnObject+' => 'Тригер на события объектов данного класса',
	'Class:TriggerOnObject/Attribute:target_class' => 'Клас',
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnPortalUpdate' => 'Тригер (обновление из портала)',
	'Class:TriggerOnPortalUpdate+' => 'Тригер на обновление объекта пользователем портала',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnStateChange' => 'Тригер (изменение статуса)',
	'Class:TriggerOnStateChange+' => 'Тригер на изменение статуса объекта',
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnStateEnter' => 'Тригер (на вход в статус)',
	'Class:TriggerOnStateEnter+' => 'Тригер на вход объекта в статус',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnStateLeave' => 'Тригер (на выход из статуса)',
	'Class:TriggerOnStateLeave+' => 'Тригер на выход объекта из статуса',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnObjectCreate' => 'Тригер (на создание объекта)',
	'Class:TriggerOnObjectCreate+' => 'Тригер на создание объекта данного или дочернего класса',
));
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:TriggerOnThresholdReached' => 'Тригер (на пороговое значение)',
	'Class:TriggerOnThresholdReached+' => 'Тригер на достижение секундомером порогового значения (TTO, TTR)',
...
Dict::Add('BG BG', 'Bulgarian', 'Български', array(
	'Class:lnkTriggerAction' => 'Связь Тригер/Действие',
...
// Synchro Data Source
//
Dict::Add('BG BG', 'Bugarian', 'Български', array(
    ...
    'Class:SynchroDataSource/Attribute:scope_class' => 'Клас',
	...
	'Menu:DataSources' => 'Източници на данни',
	'Menu:DataSources+' => 'Източници на данни',
	...
	'Core:Synchro:label_obj_created' => 'Създаден (%1$s)~~',
	...
	'Class:appUserPreferences' => 'Настройки на потребител',
...
'and' => 'и',
	// Bulk export
	'Core:BulkExport:MissingParameter_Param' => 'Липсващ параметър "%1$s"',
	'Core:BulkExport:InvalidParameter_Query' => 'Invalid value for the parameter "query". There is no Query Phrasebook corresponding to the id: "%1$s".',
	'Core:BulkExport:ExportFormatPrompt' => 'Формат на експорта:',
	'Core:BulkExportOf_Class' => '%1$s Експорт',
	'Core:BulkExport:ClickHereToDownload_FileName' => 'Натиснете за да свалите файла за %1$s',
	'Core:BulkExport:ExportResult' => 'Резултати:',
	'Core:BulkExport:RetrievingData' => 'Получаване на данни...',
	'Core:BulkExport:HTMLFormat' => 'Уеб страница(*.html)',
	'Core:BulkExport:CSVFormat' => 'Файл с разделител (*.csv)',
	'Core:BulkExport:XLSXFormat' => 'Excel формат (*.xlsx)',
	'Core:BulkExport:PDFFormat' => 'PDF документ (*.pdf)',
	'Core:BulkExport:DragAndDropHelp' => 'Маркирайте и пренаредете колони като  заглавни  за да ги подредите. Бърз преглед на %1$s реда. Общ брой на редове за експорт: %2$s.',
	'Core:BulkExport:EmptyPreview' => 'Маркирайте колони ,които да се експорират ',
	'Core:BulkExport:ColumnsOrder' => 'Ред на колоните',
	'Core:BulkExport:AvailableColumnsFrom_Class' => 'Възможни колони от данни за %1$s',
	'Core:BulkExport:NoFieldSelected' => 'Моля маркирайте поне една колона, която да се експортира',
	'Core:BulkExport:CheckAll' => 'Избери всички',
	'Core:BulkExport:UncheckAll' => 'Размаркирай всички',
	'Core:BulkExport:ExportCancelledByUser' => 'Експорта е отказан от потребителя',
	'Core:BulkExport:CSVOptions' => 'CSV Options',
	'Core:BulkExport:CSVLocalization' => 'Локализация',
	'Core:BulkExport:PDFOptions' => 'Опции за PDF',
	'Core:BulkExport:PDFPageFormat' => 'Формат на страницата',
	'Core:BulkExport:PDFPageSize' => 'Големина:',
	...
	'Core:BulkExport:OptionNoLocalize' => 'Не локализирайте стойностите)',
	'Core:BulkExport:OptionLinkSets' => 'Включване на свързаните обекти',
	'Core:BulkExport:OptionFormattedText' => 'Запази формата на текста',
	'Core:BulkExport:ScopeDefinition' => 'Дефиниция на обхвата на експорта',
	...
	'Core:BulkExport:XLSXOptions' => 'Опции на Excel експорт',
	'Core:BulkExport:TextFormat' => 'Съдържание на HTML данни',
	'Core:BulkExport:DateTimeFormat' => 'Формат на датата и часа',
	'Core:BulkExport:DateTimeFormatDefault_Example' => 'Формат по подразбиране (%1$s), e.g. %2$s',
	'Core:BulkExport:DateTimeFormatCustom_Format' => 'Разширен формат: %1$s',
	...
	'Core:Validator:Default' => 'Невалиден формат',
	'Core:Validator:Mandatory' => 'Моля попълнете задължителните полета',
	'Core:Validator:MustBeInteger' => 'Трябва да са цели числа',
	'Core:Validator:MustSelectOne' => 'Моля изберете',
));
